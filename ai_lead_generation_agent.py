...
import openai
print(openai.__version__)  # Test whether OpenAI is correctly imported
...
def create_prompt_transformation_agent(openai_api_key: str) -> Agent:
    return Agent(
        ...
        system_prompt="""You are an expert at transforming detailed user queries into concise company descriptions.
                ...
                Examples:
                Input: "Generate leads looking for embedded payment platform for payments (pay out/pay in) across different currencies for travel, business payments, lending and wage, merchant payments, other markets, investments, etc., focusing on customers using Modulr payment services."  
                Output: "embedded payment platform" 
...
def main():
    ...
    user_query = st.text_area(
        ...
        placeholder="e.g., Looking for users who need embedded payment platform for payments (pay out/ pay in) across different currencies for travel, business payments, lending and wage, merchant payments, other markets, investments etc",
